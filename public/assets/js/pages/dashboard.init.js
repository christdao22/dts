...
//         row: { colors: undefined, opacity: 0.8 },
//         column: { colors: undefined, opacity: 0.8 },
...
// var areaChart = new ApexCharts(document.querySelector("#area_chart"), areaOptions);
// areaChart.render();
...
// var columnLineChart = new ApexCharts(document.querySelector("#column_line_chart"), columnLineOptions);
...
//                     value: { show: false, fontSize: "20px", color: "#343a40", offsetY: 8 },
//                     total: { show: true, fontSize: "17px", label: "Ethereum", color: "#6c757d", fontWeight: 600 }
//                 }
//             }
//         }
//     },
