                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <a href="#" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ asset('assets/images/cdo_dts.png') }}" alt="logo-light" height="40"><span style="text-decoration: none; color: white; font-size: 1.2em; font-weight: bold; " ></span>
                                </span>
                            </a>
                        </div>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div class="user-profile text-center mt-3">
                        ...
                        <div class="mt-3 px-1">
                            ...
                            <span class="text-muted">{{ strtoupper(Auth::user()->office->office_name) }}</span>
                            <br>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            @if (Auth::user()->is_admin == 1 || Auth::user()->can_create == 1 || Auth::user()->can_view_all == 1)
                                <li>
